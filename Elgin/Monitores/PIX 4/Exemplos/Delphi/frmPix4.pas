...
begin
  if FileExists('./P1.jpg') then begin
    ...
    ShowMessage('Coloque uma imagem "P1.jpg" no diretório do executável!');
  end;
end;
...
begin
  ...
  if ret = 0 then
    memoLogs.Lines.Add('Conexão realizada com sucesso')
  else
    ShowMessage('Não foi possível realizar a conexão: Erro: ' + IntToStr(ret));
...
begin
  ...
  memoLogs.Lines.Add('Retorno Método Reinicializar Display: ' + IntToStr(ret));
end;
